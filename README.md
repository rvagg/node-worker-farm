...
```
  ...
  * **<code>argv</code>** allows you to pass data to sub processes as `process.argv`. Use this when you need to share some plain data between the main process and its sub processes.
