...
var Farm = {
      ...
      , onExit: function (childId) {
          dtracer.probes.onExit(function(p) {
            return [childId];
          })
      ...
      , startChild: function () {
          ...
          var self = this
          dtracer.probes.startChild(function(p) {
              return [self.childId]
          })
          this.activeChildren++
        }
...
//            var pid = this.children[child].pid
//            console.log('CHILD ---- \n' + child)
            dtracer.probes.stopChild(function(p) {
              return [child]
            })
      ...
      , send: function (child, call) {
          ...
          //dtracer.probes.send(function(p) {
          //  return [child]
          //})
