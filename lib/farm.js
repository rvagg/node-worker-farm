...
var Farm = {
      ...
      , setup: function (methods) {
          ...
          this.callQueue      = []
          this.moduleName     = require('../package').name

          dtracer
              .create(this.moduleName)
              .addProbe("startChild", "int", "int")
              .addProbe("stopChild", "int")
              .addProbe("onExit", "int")
              .enable()
      ...
      , onExit: function (childId) {
          dtracer.probes.onExit(function() {
            return [childId];
          })
      ...
      , startChild: function () {
          this.children[++this.childId] = {
              send        : fork(this.path, this.receive.bind(this), this.onExit.bind(this, this.childId), this.childInfo)
            , calls       : []
            , activeCalls : 0
            , pid         : this.childInfo.pid
          }
          var argChildId = this.childId, argPid = this.children[this.childId].pid
          dtracer.probes.startChild(function() {
              return [argChildId, argPid]
          })
          this.activeChildren++
        }
      ...
      , stopChild: function (child) {
          if (this.children[child]) {
            dtracer.probes.stopChild(function() {
              return [child]
            })
